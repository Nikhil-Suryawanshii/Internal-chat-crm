            ...
            >
                {loading ? (
                    ...
                    groupedMessages.map((item, idx) => {
                        ...
                        const senderName = msg.sender_name ?? (isMe ? user.name : otherName);
                                ...
                                {!isMe && isGroup && (
                                    <div style={{ flexShrink:0 }}>
                                        {msg.sender_photo_url ? (
                                            <img src={msg.sender_photo_url} alt={senderName} style={{ width:26, height:26, borderRadius:"50%", objectFit:"cover" }} />
                                        ) : (
